...
#define SCVI_STATECHART_D_IDLE 0
#define SCVI_STATECHART_D_COIN_INSERTION 0
#define SCVI_STATECHART_D_PRODUCT_BROWSER 0
#define SCVI_STATECHART_D_DISPENSED_PRODUCT 0
#define SCVI_STATECHART_D_RETURN_CREDIT 0
...
typedef enum  {
	...
	Statechart_but_E1,
	Statechart_but_E2,
	Statechart_but_browse,
	Statechart_but_enter
} StatechartEventID;
...
typedef enum
{
	...
	Statechart_d_Idle,
	Statechart_d_Coin_Insertion,
	Statechart_d_Product_Browser,
	Statechart_d_Dispensed_Product,
	Statechart_d_Return_Credit
} StatechartStates;
...
/*! Raises the in event 'E1' that is defined in the interface scope 'but'. */ 
extern void statechart_but_raise_e1(Statechart* handle);
/*! Raises the in event 'E2' that is defined in the interface scope 'but'. */ 
extern void statechart_but_raise_e2(Statechart* handle);
/*! Raises the in event 'browse' that is defined in the interface scope 'but'. */ 
extern void statechart_but_raise_browse(Statechart* handle);
/*! Raises the in event 'enter' that is defined in the interface scope 'but'. */ 
extern void statechart_but_raise_enter(Statechart* handle);
